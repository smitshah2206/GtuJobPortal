            ...
            <div class="col-xl-4 col-lg-4">
              <div class="post-details4  mb-5" style="border: 1px solid #ededed;padding: 15px 30px; ">
                ...
                <ul>
                  ...
                  <li>Enrollement No.: <span><?php echo $current_employee_details['enrollmentno'];?></span></li>
                ...
                <?php
                  if (isset($_GET['status']) && !empty($_GET['status'])) {
                    if ($current_employee_details['status'] == 3) {
                    ?>
                      <a href="employee_change_status.php?employee_id=<?php echo $employee_id;?>&status=2" class="btn btn-warning py-2 mr-1" style="color: #212529;background-color: #ffc107;">Active</a>
                      <?php
                    } 
                    if ($current_employee_details['status'] == 2) {
                    ?>
                      <a href="employee_change_status.php?employee_id=<?php echo $employee_id;?>&status=3" class="btn btn-danger py-2 mr-1">Deactive</a>
                      <?php
                    }
                  }
                ?>
