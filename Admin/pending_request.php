<?php
      ...
      $allpost_job = total_company($conn,'',5,$company_name,$company_location);
        ...
        <div class="col-md-10 tab-wrap">
          <div class="tab-content p-4" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
                      <form action="pending_request.php" method="GET" class="search-job">
                        <div class="row">
                          <div class="col-md-5">
                ...
                <div class="col-md-12 ftco-animate">
                  ...
                  <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                    ...
                    <div class="ml-auto d-flex">
                      <a href="company_change_status.php?company_id=<?php echo $row['id'];?>&status=2" class="btn btn-warning py-2 mr-1">Approve</a>
