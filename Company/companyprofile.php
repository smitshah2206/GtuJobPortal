      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 heading-section text-left ftco-animate fadeInUp ftco-animated pl-3">
            <h2 class="mb-5"><span>Company</span> Profile</h2>
          </div>
        </div>
        <form action="#">
                      ...
                      <div class="row w-100" style="margin: 0;">
                        <div class="col-md" style="padding-left: 0;">
                          <label for="email">E-Mail Address</label>
                            <h4>smitshah22050602@gmail.com</h4>
                        </div>
                        <div class="col-md" style="padding-right: 0;">
                      ...
                      <div class="row w-100" style="margin: 0;">
                        <div class="col-md" style="padding-left: 0;">
                          <label for="email">Company Name</label>
                            <h4>Yottol Financial Service</h4>
                        </div>
                      </div>
                      <div class="row w-100" style="margin: 0;">
                        <div class="col-md" style="padding-left: 0;">
                          <label for="email">Company Website</label>
                            <h4>https://www.yottol.com/</h4>
                        </div>
              ...
              <div class="form-group mb-2 h-100">
                <div class="row w-100 h-100" style="margin: 0;">
                  <div class="col-md" style="padding-left: 0;">
                    ...
                    <h4>sdsdsssssssssssssssssssssssssssssssssssssssssssdddddddddddddssssssss</h4>
                  </div>
                </div>
              </div>
            </div>
        ...
        <fieldset class="scheduler-border">
            ...
            <div class="col-md-12">
                    <div class="form-group mb-2">
                      <div class="row w-100" style="margin: 0;">
                        ...
                        <div class="col-md" style="padding-right: 0;">
                          <label for="email">Number of Vacancies</label>
                            <h4>5</h4>
                        </div>
                        <div class="col-md" style="padding-right: 0;">
          ...
          <div class="row">
            <div class="col-md-6">
              <label for="email">Eligiblity Crieteria</label>
              <h4>dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddwwwwwwwwwwwwwwwwwwww</h4>
            </div>
            <div class="col-md-6">
        ...
        <fieldset class="scheduler-border">
          <legend class="scheduler-border">Follow on Social Media</legend>
          <div class="row">
            <div class="col-md-12 justify-content-center align-item-center d-flex">
              <a href=""><h2 class="icon-whatsapp mr-5 ml-5"></h2></a>
              <a href=""><h2 class="icon-facebook mr-5 ml-5"></h2></a>
              <a href=""><h2 class="icon-linkedin mr-5 ml-5"></h2></a>
            </div>
          </div>
        </fieldset>
