<?php
      ...
      $allpost_job = total_post_job($conn,$_SESSION['id'],'','`job_post`.`created_time`',$job_category,$job_type,$job_location);
      $job_category_list = job_category($conn,$_SESSION['id']);
      $job_location_list = job_location($conn,$_SESSION['id']);
        ...
        <div class="row">
          ...
          <div class="col-md-2 heading-section ftco-animate fadeInUp ftco-animated pl-3">
              <div class="ml-auto d-flex" style="width: 100%;height: 100%;justify-content: center;align-items: center;">
                <a href="createnewpost.php" class="btn btn-success py-2 mr-1">Create New Post</a>
              </div>
          </div>
        </div>
        <div class="row">
