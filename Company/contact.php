    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-3">
            <p><span>Phone:</span><br><a href="javascript:void(0)">+91-<?php echo $editContactNumber;?></a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span><br><a href="javascript:void(0)"><?php echo $editContactEmail;?></a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span><br><a href="#"><?php echo $editContactWebsite;?></a></p>
          </div>
        </div>
